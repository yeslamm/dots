-- 1. Helper / companion tools setup
...
-- 2. LSP Keymaps & Autocommands on buffer attach
...
-- -- 5. Mason automated installation
...
-- 6. Capabilities and server launching via mason-lspconfig
